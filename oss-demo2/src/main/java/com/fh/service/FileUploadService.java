...
import com.fh.config.AliyunConfig;
import com.fh.mapper.OssMapper;
...
public class FileUploadService {
     ...
     * @email gaojun56@163.com
     */
    public FileUploadResult upload(MultipartFile uploadFile, Oss oss) {
        // 校验图片格式
    ...
    public List<Oss> list() {
       ...
       //查询本地的数据
       List<Oss> osses = ossMapper.selectList(null);
        return osses;
    }
     ...
     * @email gaojun56@163.com
     */
    public FileUploadResult delete(String objectName, Integer id) {
